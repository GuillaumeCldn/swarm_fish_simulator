...
class Building:
    ...
    def inflate(self, safetyfac=1.1, rad=1e-5):
        # run this method even if radius is 0 because vertices are then ordered anticlockwise CRUCIAL!
        rad = rad * safetyfac
        scale = 1e6
